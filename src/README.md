...
url               | String   | http://osm.personalwerk.de/example-vectiles/{z}/{x}/{y}.pbf.base64 | URL to the `.pbf.base64`-Files describing the actual tile content. Read the Section about *Obtaining or Generating Vector-Tiles* in the main [README-File](../README.md). You should probably host them on your own domain, too.
...
fillStyle         | String   | orange                                                             | Default Fill-Style accoring to the [Canvas-Specification](https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D.fillStyle)
strokeStyle       | String   | black                                                              | Default Stroke-Style accoring to the [Canvas-Specification](https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D.strokeStyle)
